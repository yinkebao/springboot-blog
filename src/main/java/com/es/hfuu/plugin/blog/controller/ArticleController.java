...
public class ArticleController extends BaseController {
  ...
  @ResponseBody
  public EsResult<List<ArticleVO>> listMyArticles(Long userId) {
    return providerServiceInvokeFunction(articleService::listMyArticles,userId);
  }

  @ApiOperation(value = "查询我收藏的文章")
  @RequestMapping(value = "/listCollectArticles", method = RequestMethod.GET)
  @ResponseBody
  public EsResult<List<ArticleVO>> listCollectArticles(Long userId) {
    return providerServiceInvokeFunction(articleService::listCollectArticles,userId);
  }

  @ApiOperation(value = "统计我的文章信息")
  @RequestMapping(value = "/countMyArticleInfo", method = RequestMethod.GET)
  @ResponseBody
  public EsResult<MyArticleVo> countMyArticleInfo(Long userId) {
    return providerServiceInvokeFunction(articleService::countMyArticleInfo,userId);
  }
  ...
  @RequestMapping(value = "/siteTitlePage", method = RequestMethod.POST)
  @ResponseBody
  public EsResult<Boolean> siteTitlePage(@RequestParam String titlePage, String ids) {
    return providerServiceInvokeConsumer(articleService::siteTitlePage,titlePage ,ids);
  }
